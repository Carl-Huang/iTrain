...
{
    UIColor *uicolor=[[UIColor alloc]initWithRed:121/255.0 green:121/255.0 blue:121/255.0 alpha:1.0];
    self.layer.borderColor = uicolor.CGColor;
    CAGradientLayer *gradient = [CAGradientLayer layer];
    gradient.frame = self.oneView.frame;
    gradient.colors = [NSArray arrayWithObjects:(id)[UIColor whiteColor].CGColor,(id)[[UIColor alloc]initWithRed:249/255.0 green:237/255.0 blue:191/255.0 alpha:1.0].CGColor,nil];
    self.twoLabel.textColor = prsColor;
    [self.oneView.layer insertSublayer:gradient atIndex:0];
}
